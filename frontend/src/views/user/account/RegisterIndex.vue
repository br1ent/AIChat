...
import CONFIG_API, {TEXT_INPUT_DISABLED} from "@/js/config/config.js";
...
<template>
  <div class="flex justify-center mt-16 px-4 sm:mt-30">
    <form @submit.prevent="register" class="fieldset bg-base-200 border-base-300 rounded-box w-xs max-w-full border p-4">
