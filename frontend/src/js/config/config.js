...
export const TEXT_INPUT_DISABLED = false
...
if (platform === 'vue') {
    ...
    CONFIG_API.HTTP_URL = 'https://app8109.acapp.acwing.com.cn';
    CONFIG_API.VAD_URL = 'https://app8109.acapp.acwing.com.cn/static/frontend/vad/';
}
